      ...
      <div className="w-full md:w-1/2 h-full bg-white flex flex-col overflow-y-auto">
        ...
        <div className="hidden md:flex justify-between items-center p-8 pb-4">
          ...
          >
            <HeartIcon
              filled={isFavorite}
              className={`w-6 h-6 ${animatingHeart ? "scale-125" : "scale-100"} transition-transform`}
            />
          </button> */}
        </div>
                  ...
                  {dish.ingredients.map((ing) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => ing.removable && toggleIngredient("")}
                        className={`
